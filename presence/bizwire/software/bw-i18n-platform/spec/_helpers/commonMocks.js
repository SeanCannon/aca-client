...
const R       = require('ramda'),
      dbUtils = require('@businesswire/bw-node-mysql-connector')(null);
...
const validationErr = R.curry((errorCode, identifier, property) => {
  const errorTemplate           = errors.validation[errorCode]({
...
const noResultsErr       = errors.db.NO_QUERY_RESULTS();
const duplicateRecordErr = errors.db.DUPLICATE();
